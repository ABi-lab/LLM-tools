<?php
/**
 * web_search_ddg — Search DuckDuckGo and return results as plain text.
 */
...
function showForm_web_search_ddg(): void {
    header('Content-Type: text/html; charset=utf-8');
    echo <<<HTML
    <!DOCTYPE html><html><head><title>web_search_ddg</title></head><body>
    <h2>DuckDuckGo Web Search</h2>
