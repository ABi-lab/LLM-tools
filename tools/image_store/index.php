<?php
/**
 * image_store — Store a base64 image and return its served URL.
 * Called directly: php tools/image_store/index.php image=<b64> mime=image/jpeg
 * Or dispatched by the router.
 */
